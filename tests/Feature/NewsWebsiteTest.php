...
class NewsWebsiteTest extends TestCase
{
  ...
  $response = $this->post('/save-post', [
   ...
   'title' => 'Netcix cuts out the chill with an integrated personal trainer on running.',
    ...
    'admin_id' => '1','image' => 'health1.jpg','image_path' => 'images/posts/health/health1.jpg','video_path' => 'https://www.youtube.com/watch?v=_0UO1NcheAE','publish_time' => 'Published','discussion' => 'Allow comment','visibility' => 'Public', 
