              ...
              <div class="card-body px-5 py-5">
                ...
                @enderror
                  ...
                  <div class="form-group">
                    ...
                    <input type="password" class="form-control p_input @error('password_confirmation') is-invalid @enderror" placeholder="Confirm Password" name="password_confirmation">
