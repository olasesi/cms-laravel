  ...
  <div class="container-scroller">
    ...
    <nav class="navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
      <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-center">
        <a class="navbar-brand brand-logo mr-5" href="index.html"><img/logo.svg" class="mr-2" alt="logo"/></a>
        <a class="navbar-brand brand-logo-mini" href="index.html"><img/logo-mini.svg" alt="logo"/></a>
      </div>
          ...
          <div class="row">
            ...
            <div class="col-md-5 grid-margin stretch-card">
                  ...
                  <div class="add-items d-flex mb-0 mt-2">
										...
										<button class="add btn btn-icon text-primary todo-list-add-btn bg-transparent"><i class="icon-circle-plus"></i></butt							</div>
								</div>
							</div>
            </div>
          </div>
              ...
              <div class="card">
                <div class="card-body">
                  ...
                  <ul class="icon-data-list">
                    <li>
                      <div class="d-flex">
                        <img src="/faces/face1.jpg" alt="user">
                        <div>
                    ...
                    <li>
                      <div class="d-flex">
                        <img src="/faces/face2.jpg" alt="user">
                        <div>
                    ...
                    <li>
                      <div class="d-flex">
                      <img src="/faces/face3.jpg" alt="user">
                     <div>
                    ...
                    <li>
                      <div class="d-flex">
                        <img src="/faces/face4.jpg" alt="user">
                        <div>
